<?php
    ...
    $result = mysqli_query($mysqli, "INSERT INTO lista3(Produto,Unidade) VALUES ('$Produto','$Unidade')");
    }
...
<head>
    ...
    <title>CadastraDeProdutoLista3</title>
    ...
    <div class="box">
        <form action="sistema3.php" method="post">
            <fieldset class="fieldset">
                <legend class="legend"><b>Lista 3</b></legend>
                <br>
